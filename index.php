...
try {
    ...
    $destinations = [];
    echo "<script>alert('Error fetching destinations: " . addslashes($e->getMessage()) . "');</script>";
}
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
    ...
    <section class="hero">
        ...
        <a href="#" onclick="navigate('search.php')" class="btn">Start Exploring</a>
    </section>
    <section class="destinations">
        <?php if (empty($destinations)): ?>
            <div class="error">No destinations available at the moment.</div>
        <?php else: ?>
